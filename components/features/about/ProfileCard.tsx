        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            <a
              href="/CV_EN.pdf"
              download
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-white/[0.12] border border-white/20 hover:bg-white/[0.18] transition-colors text-sm text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-pastel-orange"
            >
            ...
            <a
              ...
              className="p-2.5 rounded-xl bg-white/[0.12] border border-white/20 hover:bg-white/[0.18] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-pastel-orange"
            >
